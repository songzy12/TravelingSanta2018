...
void ReadProblem()
{
    ...
    LastLine = 0;
    if (0) {
    void ReadCq_matrix(char * FileName);
//    ReadCq_matrix("instances/Symmetric_Class_1/dim_30/r3_30_1.sqtsp");
//    Optimum = 12537;
    ReadCq_matrix("instances/Symmetric_Class_1/dim_30/r3_30_2.sqtsp");
    Optimum = 11825;
    GainType Penalty_SQTSP();
    Penalty = Penalty_SQTSP;
    ProblemType = MLP;
    }
}
